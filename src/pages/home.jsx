...
const Home = () => {
  return (
    <>
      <section className=" bg-black lg:h-full max-sm:h-full md:w-4xl">
        ...
        <div className="bg-white h-30  max-sm:w-4xl lg:w-4xl  rounded-lg flex justify-center items-center place-self-center gap-10">
