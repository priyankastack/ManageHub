    ...
    <>
      <section className=" bg-black lg:h-full max-sm:h-full max-sm:w-full lg:w-full">
        ...
        <div className="bg-white max-sm:h-20 lg:h-30 lg:w-4xl max-sm:w-lg rounded-lg flex justify-center items-center place-self-center gap-10">
          <div className=" lg:h-15 max-sm:h-8 flex flex-col lg:justify-center lg:items-center lg:px-8 max-sm:px-6 border-r-black border-r-2 ">
          ...
          <div className=" lg:h-15 max-sm:h-8 flex flex-col lg:justify-center lg:items-center max-sm:justify-center max-sm:items-center lg:px-8 max-sm:px-6 border-r-black border-r-2 ">
          ...
          <div className=" lg:h-15 max-sm:h-8 flex flex-col lg:justify-center lg:items-center max-sm:justify-center max-sm:items-center lg:px-8 max-sm:px-6">
